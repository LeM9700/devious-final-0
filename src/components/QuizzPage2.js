        ...
        <ReactFullpage
          ...
          render={({ state, fullpageApi }) => {
            return (
                ...
                <div className='section'><Button variant= "outlined"onClick={() => handleButtonClick()}>Retour à Accueil</Button><QuizzIDV/></div>
                <div className='section'><Button variant= "outlined"onClick={() => handleButtonClick()}>Retour à Accueil</Button><QuizzLCVF/></div>
